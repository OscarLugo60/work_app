"""
URL configuration for work_app project.
...
schema_view = get_schema_view(
    openapi.Info(
        title="Documentación Sistema de Tareas",
        default_version='v1',
        description="API de Desarrollo",
        term_of_service="https://n.grupoelpaso.com",
        contact=openapi.Contact(email="sistemas.cmdep@gmail.com"),
